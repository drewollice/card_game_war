...
{
	public War (final Collection<Card> spoilsOfWar, final Player player1, final Player player2)
	{
		super(spoilsOfWar, player1, player2);
	}
	...
	private void drawCards ()
	{
		...
		this.spoilsOfWar.addAll(this.player1.drawCards(3, false));
		...
		this.spoilsOfWar.addAll(this.player2.drawCards(3, false));
